...
%%RUN DESCRIPTION
% There are 20 blocks.
% Categories of stimuli = 2 (syllable and scramble). Alternation
% SYLL-SCR-SYLL-SCR-....
...
% Trial duration = duration of each audio file + n msec to arrive to
% 1.2s/trial.  ?????????? OR 1s ????????????
...
% 20 blocks per run : minimum 360s / maximum 400s (according to 0, 1 or 2
% targets)
% 20 pauses of 6s = 120s
% 
% MINIMUM DURATION = 488s (8min08sec) / MAXIMUM DURATION = 528s (8min48sec)
