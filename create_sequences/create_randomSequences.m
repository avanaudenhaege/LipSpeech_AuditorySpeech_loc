...
seq01 = random_stim(1:15); %take the 20 first to create seq01
SYLseq01 = strcat('SYL', seq01); % create the SYL and SCR vectors
SCRseq01 = strcat('SCR', seq01);

seq02 = random_stim(16:30); %take the 20 next, and so on. 
...
save('/Users/alice/Documents/MATLAB/Lipreading_PTB/PhonoLoc_bisyll/sequences-NEW') ; 
